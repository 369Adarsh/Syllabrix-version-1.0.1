        ...
        <div className="px-4 pb-4 border-t border-gray-100 pt-3 space-y-4">
          ...
          {topic.theory_content ? (
            ...
            <div className="rounded-xl bg-gray-50 border border-dashed border-gray-200 p-4 text-center">
              ...
              <p className="text-[12px] text-gray-500 mb-2">No study notes yet for this topic.</p>
              <button
              ...
              >
                {generating ? <><Loader2 size={12} className="animate-spin" /> Generating...</> : <><Zap size={12} /> Generate AI Notes</>}
              </button>
            </div>
          )}
  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-4 mb-4" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.06)' }}>
            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              ...
              {chapter.jee_main_weightage > 0 && (
                <span className="text-[10px] px-2 py-0.5 rounded-full bg-blue-50 text-blue-600 font-medium">
                  {chapter.jee_main_weightage}% JEE Main weightage
                </span>
              )}
        ...
        {/* Mastery selector */}
        <div>
          <p className="text-[10px] uppercase tracking-wide text-gray-400 font-semibold mb-1.5">Update your mastery level</p>
      ...
      <div>
        ...
        {topics.length === 0 ? (
          <div className="text-center py-10 bg-white rounded-xl border border-gray-100">
            ...
            <p className="text-[13px] text-gray-500">No topics yet for this chapter.</p>
            <p className="text-[11px] text-gray-400 mt-1">Topics will appear as the database is populated.</p>
          </div>
        ) : (
