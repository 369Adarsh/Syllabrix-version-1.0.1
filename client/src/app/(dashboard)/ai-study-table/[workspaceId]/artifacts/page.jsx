...
export default function WorkspaceArtifacts() {
  ...
  const type = searchParams.get('type'); // flashcard_set, quiz, study_guide, etc.
      ...
      <div className="max-w-xl w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 border border-slate-100 relative overflow-hidden">
          ...
          <div className="relative z-10 text-center mb-8">
            ...
            <h1 className="text-2xl font-black text-slate-900 mb-2">{titles[type]}</h1>
            <p className="text-slate-500 font-medium">{desc[type]}</p>
          </div>
          ...
          <form onSubmit={handleGenerate} className="space-y-5 relative z-10">
            <div>
              ...
              <input
                ...
                placeholder="E.g., The French Revolution, Mitochondria..."
            ...
            >
              {generating ? <><Loader2 className="animate-spin" size={20} /> AI Generating from Sources...</> : <><BookOpen size={20} /> Generate</>}
            </button>
          </form>
