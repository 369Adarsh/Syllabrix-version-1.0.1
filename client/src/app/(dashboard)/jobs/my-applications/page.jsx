...
export default function Page() {
  ...
  useEffect(() => { jobsAPI.getMyApplications().then(r => setData(r.data?.data || [])).catch(() => {}).finally(() => setLoading(false)); }, []);
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-sm"><FileText size={20} className="text-white" /></div>
        <h1 className="font-bold text-lg text-gray-800">My Applications</h1>
      </div>
