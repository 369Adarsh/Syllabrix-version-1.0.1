...
export default function CreatePostBox({ onPostCreated }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setUploadProgress(100); setContent(''); removeMedia(); setExpanded(false);
  ...
  return (
    <div className="bg-white rounded-xl shadow-[0_1px_2px_rgba(0,0,0,0.1)] border border-gray-200/60">
      ...
      <div className="flex items-center px-2 py-1.5">
        ...
        <button className="flex-1 flex items-center justify-center gap-2 py-2 rounded-lg text-[13px] font-medium text-gray-600 hover:bg-[#F0F2F5] transition-colors">
