  ...
  const [result] = await pool.query(
    `INSERT INTO student_profiles
     ...
     ON DUPLICATE KEY UPDATE
       ...
       linked_guardian_id = VALUES(linked_guardian_id),
       requires_guardian = VALUES(requires_guardian),
       education_level = VALUES(education_level),
       subject_stream = VALUES(subject_stream),
       ...
       difficult_subject = VALUES(difficult_subject),
       loved_professions = VALUES(loved_professions),
       future_vision = VALUES(future_vision),
       sports = VALUES(sports),
       sports_level = VALUES(sports_level),
       exam_type = VALUES(exam_type),
       exam_target_year = VALUES(exam_target_year),
       specialization_courses = VALUES(specialization_courses),
       mandatory_courses = VALUES(mandatory_courses)`,
    [
