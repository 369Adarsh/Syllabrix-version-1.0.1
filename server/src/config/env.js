...
module.exports = {
  ...
  DB_SOCIAL: {
    ...
    NAME: process.env.DB_SOCIAL_NAME || process.env.DB_NAME || 'syllabrix_social',
    ...
    SSL: (process.env.DB_SOCIAL_SSL || process.env.DB_SSL) === 'true',
  },
  DB_LD: {
    HOST: process.env.DB_LD_HOST || process.env.DB_HOST || 'localhost',
    PORT: parseInt(process.env.DB_LD_PORT || process.env.DB_PORT || '3306', 10),
    NAME: process.env.DB_LD_NAME || process.env.DB_NAME || 'syllabrix_corporate',
    USER: process.env.DB_LD_USER || process.env.DB_USER || 'root',
    PASSWORD: process.env.DB_LD_PASSWORD || process.env.DB_PASSWORD || '',
    CONNECTION_LIMIT: parseInt(process.env.DB_CONNECTION_LIMIT || '5', 10),
    SSL: (process.env.DB_LD_SSL || process.env.DB_SSL) === 'true',
  },
  DB: {
